        ...
        address_component_from_google_geocode: function(address_components) {
            ...
            for (var i = address_components.length-1; i>=0; i--) {
                ...
                // State \ Province
                    ...
                    result.stateOrProvince1 = component.long_name;
                }
                // State \ Province
                else if (component.types.indexOf('administrative_area_level_2') >= 0) {
                    result.stateOrProvince2 = component.long_name;
                }
                // State \ Province
            ...
            result.addressLine2 = '';
            result.administrative_area_level_1 =result.stateOrProvince1;
            result.administrative_area_level_2 =result.stateOrProvince2;
            return result;
        }
    };

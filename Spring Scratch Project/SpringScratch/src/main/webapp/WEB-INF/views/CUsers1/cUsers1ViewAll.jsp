...
<%
System.out.println("CUser1ViewAll ");
	if(request.getAttribute("usersList")!=null){
		
	List<CUsers> usersList = (List<CUsers> ) request.getAttribute("usersList");
	List<CUserRole> userRole = new ArrayList<CUserRole>();
	if(request.getAttribute("userRole")!=null){
		userRole = (List<CUserRole> ) request.getAttribute("userRole");
	}
	int curRole=0,typeId=-1;
...
/*     String usersType=request.getAttribute("usersType").toString(); */
    ...
    String changePwd= request.getContextPath() + "/cUsers1/changePwd?";
    String activeStatus= request.getContextPath() + "/cUsers1/changeActiveSt?";
    String baseUrl;
    String baseUrlSearch;
    baseUrl=request.getContextPath()+"/cUsers1?";
	baseUrlSearch=request.getContextPath()+"/cUsers1/search?";
	String pageTitle="";
    String roleBaseUrl=request.getContextPath()+"/cUsers1/rolePost?";
...
<div class="row">
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								...
								<li>
									<div class="row">
										...
										<div class="col-sm-4">
											<a
												href="javascript:getAjaxHtmlModal('myModalUserRole','<%=roleBaseUrl+"cmd="+CMD.EDITIND+"&recId="+role.getId()+"&typeId="%>');"><i
												class="fa fa-pencil-square-o"></i></a> <a
												onclick="if(confirmDeleteNew('<%=role.getRole_value() %>')===true){ javascript:getAjaxJson('<%=divName%>', '<%=roleBaseUrl + "cmd=" + CMD.DELETE + "&recId="+role.getId()+"&role="+curRole+"&typeId="+typeId%>');}"><i
								...
								<li>
									<div class="row">
										<div class="col-sm-8">
											<a
												href="javascript:getAjaxHtmlModal('myModalUserRole','<%=roleBaseUrl+"cmd="+CMD.ADDIND+"&typeId="+typeId %>');">
												<span>Add New</span></a>
										</div>
										<div class="col-sm-4">
											<a
												href="javascript:getAjaxHtmlModal('myModalUserRole','<%=roleBaseUrl+"cmd="+CMD.ADDIND+"&typeId="+typeId %>&role1=');"><i
							...
							<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								<li>
									<div class="row">
										<div class="col-sm-8">
											<a
												href="javascript:getAjaxHtmlModal('myModalUserRole','<%=roleBaseUrl+"cmd="+CMD.ADDIND+"&typeId="+typeId %>&role1=');">Add
												New</a>
										</div>
										<div class="col-sm-4">
											<a
 ...
 %> <span class="label" style="line-height: 3"><i
								...
								<%
									int activeSts=user.getActivation_sts();
								%>
								<td class="center"
									style="text-align: center; float: left; width: 15%">
									<%
										if(user.getActivation_sts()==1){
									%>
									<div
 ...
 %>
								...
								<td style="text-align: center; float: left; width: 10%">
									<%
										if(!(user.getPassword()==null ||user.getPassword().equals(""))){

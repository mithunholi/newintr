...
<%
	...
	String[] paths = { "/dashboard", "/employees", "/users","/cUsers1" };
	String[] display = { "Dashboard", "Employee", "User" ,"Customer User 1"};
...
<aside class="main-sidebar box-shadow">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu side-adm">
			...
			%>
			<li id="dash" class=<%=active%>><a
				href="javascript:getAjaxMenuHtml('content-wrapper','${pageContext.request.contextPath}<%=paths[i]%>');"><i
					class="fa fa-dashboard"></i> <span><%=display[i]%></span></a></li>

<%
 ...
 <nav>
  <ul id="pagination" class="pagination paginationC-sm">
...
<div class="col-sm-4 text-center-xs col-xs-12 text-left">
...
function gotoPage(pageNum){
	...
	totalPage=<%=totPages%>;
	if(cpage><%=totPages%>){
		bootbox.alert('There is only '+totalPage+' pages available');
		$('#pageNum').val("");

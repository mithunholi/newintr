jQuery(function($) {
        ...
        $('<div class="prepbootstrap-sharing-container"></div>')
            ...
            .append(
                $('<div class="sharing-item sharing-fb hidden-xs"><div class="sharing-img"></div></div>').click(function () {
                    open_popup(
                ...
                $('<div class="sharing-item sharing-gp hidden-xs"><div class="sharing-img"></div></div>').click(function () {
                    open_popup(
                ...
                $('<div class="sharing-item sharing-tw hidden-xs"><div class="sharing-img"></div></div>').click(function () {
                    open_popup(
                ...
                $('<div class="sharing-item sharing-li hidden-xs"><div class="sharing-img"></div></div>').click(function () {
                    open_popup(
